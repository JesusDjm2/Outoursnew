...
<div class="space-y-6">
    <div class="rounded-3xl border border-slate-200 bg-gradient-to-br from-slate-900 via-slate-800 to-slate-700 p-6 text-white shadow-xl">
        <div class="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
            <div>
                ...
                <p class="mt-2 max-w-2xl text-sm text-slate-300">Aquí tienes una vista rápida de tus operaciones: tours, itinerarios, hoteles, habitaciones y usuarios, con un acceso más claro a cada módulo.</p>
            </div>
    ...
    <div class="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
        @php($cards = collect([
            ...
            ['icon' => 'fa-route', 'color' => 'from-emerald-500 to-green-500', 'value' => $stats['itinerarios'], 'label' => 'Actividades', 'route' => 'itineraries.index'],
