@php($tabs = [
    'destinos' => ['route' => 'destinos.index', 'label' => 'Destinos y Categorías'],
    'actividades' => ['route' => 'itineraries.index', 'label' => 'Actividades'],
])
<div class="mb-4 flex gap-2 border-b border-gray-200 dark:border-slate-800">
